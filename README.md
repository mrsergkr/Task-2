Программа посимвольно считывает файл strings.txt, пока не прочитает первую строку или пока не закончится файл, и возвращает количество слов в первой строке.
